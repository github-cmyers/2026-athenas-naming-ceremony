export default function AboutNamingCeremony() {
  return (
    <section className="max-w-2xl mx-auto px-4 mb-12">
      <div className="bg-white/70 backdrop-blur rounded-2xl p-6 shadow-lg">
        ...
        <div className="space-y-4 text-gray-700">
          <p>
            A naming ceremony is a joyous celebration that formally welcomes a newborn
          ...
          <div className="border-l-4 border-rose-400 pl-4 my-4">
            ...
            <p>
              In Mali and throughout West Africa, the naming ceremony — known as
              &quot;denw tɔgɔ dali&quot; in Bambara — is one of the most important celebrations
